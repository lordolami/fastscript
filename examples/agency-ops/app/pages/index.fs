...
export default function Home() {
  return `
    <section class="agency-hero">
      <div class="saas-chip">Internal product track · Agency Ops SaaS</div>
      <div class="hero-grid">
        <section class="list-card">
        ...
        <section class="list-card">
          ...
          <div class="detail-list">
            ...
            <div><div class="detail-label">Backend</div><div class="detail-value">Agency, clients, billing, and notification APIs</div></div>
            <div><div class="detail-label">Jobs</div><div class="detail-value">Invoice receipts and ops follow-up queue flow</div></div>
            <div><div class="detail-label">Deploy</div><div class="detail-value">Cloudflare-ready adapter generation</div></div>
          </div>
        </section>
      </div>
      <div class="metric-grid">
        ...
        ${card("Ops visibility", "Track invoices, queued jobs, and follow-up actions from the same product dashboard.")}
      </div>
    </section>
  `;
}
