export const COMPATIBILITY_REPORT = {
  "generatedAt": "2026-04-19T00:35:31.477Z",
  "governanceTrack": "4.1",
  "stableLine": "5.0.x",
  "packageVersion": "5.0.0",
  "contract": "If a feature, ecosystem pattern, or security claim is marked proven, it must have automated coverage and release gates must fail when that proof regresses.",
  "summary": {
    "entries": 34,
    "byStatus": {
      "proven": 32,
  ...
  "entries": [
    ...
    },
    {
      ...
      "status": "proven",
      "contractNote": "Dynamic import and CommonJS-style require should remain usable in rename-first .fs code.",
      "proofIds": [
    ...
    },
    {
      ...
      "status": "proven",
      "contractNote": "Supported import assertion shapes should survive rename-first conversion into .fs.",
      "proofIds": [
    ...
    },
    {
      ...
      "category": "framework-patterns",
      "feature": "Ordinary TypeScript product-shaped .fs apps",
      "status": "proven",
      ...
      "docsNote": "Covers the Agency Ops proving-ground app: ordinary TypeScript authoring, dashboard routes, session bootstrap, work-item flow, assignment workflow, billing, jobs, and Cloudflare-ready generation.",
      "proofDetails": [
        {
          "id": "script:test:agency-ops",
          "status": "configured",
    ...
    {
      "id": "authenticated-dashboard-assignment-flows",
      "category": "framework-patterns",
      "feature": "Authenticated dashboard assignment and workload flows",
      "status": "proven",
      "contractNote": "Role-aware dashboard mutations such as assignment, reassignment, workload views, and authenticated operational flows should remain valid .fs product patterns.",
      "proofIds": [
        "script:test:agency-ops"
      ],
