export const COMPATIBILITY_REPORT = {
  "generatedAt": "2026-04-16T20:09:48.157Z",
  "governanceTrack": "4.0",
  "stableLine": "3.0.x",
  ...
  "entries": [
    ...
    },
    {
      ...
      "docsNote": "Covers the Agency Ops proving-ground app: strict TypeScript authoring, dashboard routes, session bootstrap, work-item flow, assignment workflow, billing, jobs, and Cloudflare-ready generation.",
      "proofDetails": [
        {
          "id": "script:test:agency-ops",
          "status": "configured",
