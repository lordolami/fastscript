...
export const PUBLIC_TITLE = "FastScript v4.0.1 - Complete TypeScript full-stack platform";
...
export const PUBLIC_TWITTER_DESCRIPTION = "FastScript 4.0.1 is the complete TypeScript platform release: ordinary TS in .fs, proof-backed validation, reference apps, and deploy-ready outputs from one runtime.";
export const PUBLIC_SSR_SHELL_DESCRIPTION = "FastScript v4.0.1 serves a complete TypeScript full-stack runtime: ordinary TS in .fs, proof-backed validation, and deploy-ready pages, APIs, jobs, and data flows.";
