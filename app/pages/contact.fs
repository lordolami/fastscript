  ...
  return `
    ...
    <section class="home-cta reveal">
      <div class="cta-block">
        ...
        <p class="cta-copy">Bug reports on the latest stable version (v3.x) receive priority. v1, v1.1, and v2 are historical lines. Production support agreements are available for enterprise teams &mdash; contact us.</p>
