  ...
  return `
    ...
    <section class="home-cta reveal">
      <div class="cta-block">
        ...
        <p class="cta-copy">Bug reports on the latest stable version (v1.x) receive priority. Legacy pre-stable versions are not actively maintained. Production support agreements are available for enterprise teams &mdash; contact us.</p>
