    ...
    <section class="reveal">
      ...
      <div class="story-grid">
        ...
        <div class="story-cell">
          ...
          <p class="story-cell-copy">Each stable major version receives 18 months of active maintenance and 6 months of security-only fixes. The current 5.x line is actively maintained; 4.x is the previous stable line, while v1, v2, and v3 remain historical reference lines.</p>
        </div>
        <div class="story-cell">
