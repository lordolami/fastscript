...
The Team Dashboard SaaS is the first official FastScript greenfield product baseline.

- Stable CLI/template id: `fastscript create startup-mvp --template startup-mvp`
