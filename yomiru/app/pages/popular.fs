import { getPopular } from '../lib/anilist.fs';

export async function loader({ url }) {
  const page = parseInt(url.searchParams.get('page') || '1');
  const anime = await getPopular(page, 24);
  return { anime, page };
}
    ...
    <div class="page">
      <div class="container">
        <div class="page-header">
          <h1 class="page-title">⭐ Most Popular Anime</h1>
          <p class="page-subtitle">The most loved anime by the community</p>
        </div>
